...
public class AccuracyErrorDialog extends javax.swing.JFrame {
    ...
    public AccuracyErrorDialog(String error) {
    	this.error = error;
        initComponents();
    }
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(409, 259));
        setResizable(false);
